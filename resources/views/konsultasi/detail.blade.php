                            ...
                            <div class="nk-chat border-0">
                                <div class="nk-chat-body">
                                    <div class="nk-chat-head">
                                        <div class="lead-text">{{ auth()->user()->role == 'guest' ? 'Pakar' : $konsultasi->user->name }}</div>
                                    </div><!-- .nk-chat-head -->
                                                ...
                                                <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                                                    <div class="simplebar-content-wrapper" style="height: auto; overflow: hidden scroll;">
                                                        <div class="simplebar-content" style="padding: 20px 28px;">
                                                            <div class="chat {{ auth()->user()->role == 'guest' ? 'is-me' : 'is-you' }}">
                                                            ...
                                                            @foreach($konsultasi->jawaban as $jawaban)
                                                                ...
                                                                <div class="{{ $jawaban->pakar == 1 ? 'chat is-you' : 'chat is-me' }}">
                                                                    <div class="chat-content">
                                                                        <div class="chat-bubbles">
                                                                            <div class="chat-bubble">
                                                                                <div class="chat-msg">{{ $jawaban->jawaban }}</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                @else
                                                                <div class="{{ $jawaban->pakar == 1 ? 'chat is-me' : 'chat is-you' }}">
                                                                    <div class="chat-content">
                                                                        <div class="chat-bubbles">
                                                                            <div class="chat-bubble">
                                                                                <div class="chat-msg">{{ $jawaban->jawaban }}</div>
