                                ...
                                <tbody>
                                    @foreach ($konsultasi as $konsul)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-warning" href="{{ route('konsultasi.detail', $konsul->id_konsultasi) }}">Lihat</a>
                                                <form class="d-inline" action="{{ route('konsultasi.delete', $konsul->id_konsultasi) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
