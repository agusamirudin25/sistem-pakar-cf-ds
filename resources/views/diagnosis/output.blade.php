...
<div class="card">
    <div class="card-body">
        <main id="main" class="main">
            ...
            @endforeach
            <h5>Hasil perhitungan dari kerusakan {{ $sessData['nama_jenis']->nama_jenis }} menggunakan <b>CF</b> mempunyai nilai {{ $sessData['hasil_cf'] }} di presentase kan menjadi {{ $sessData['persentase_hasil_cf'] }}</h5>
            ...
            <h5>Hasil perhitungan dari kerusakan {{ $sessData['nama_jenis']->nama_jenis }} menggunakan <b>Dempster Shafer</b> mempunyai nilai {{ $sessData['hasil_ds'] }} di presentase kan menjadi {{ $sessData['presentase_hasil_ds'] }}</h5>
            <hr>
